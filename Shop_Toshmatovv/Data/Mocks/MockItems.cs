...
namespace Shop_Toshmatovv.Data.Mocks  // ИСПРАВЬ namespace (было Shop.Data.Mocks)
{
    public class MockItems : IItems
    {
        private readonly ICategorys _category;  // Измени на private

        public MockItems()  // Добавь конструктор
        {
        ...
        // ВАЖНО: УДАЛИ все строки после этого, особенно:
        // public IEnumerable<Items> ALlItems => throw...
        // string? IItems.AllItems { get => throw...
    }
}